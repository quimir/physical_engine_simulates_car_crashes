...
void SettingWindow::CreateWindowLayout()
{
    ...
    {
        FileWriteSystem::GetInstance().OutMessage(FileWriteSystem::MessageTypeBit::kWarning
    ...
    {
        FileWriteSystem::GetInstance().OutMessage(FileWriteSystem::MessageTypeBit::kWarning,"No main layout created");
    }
...
void SettingWindow::HandleButtonClicked()
{
    ...
    // Returns a pointer to the object that sent the signal (in this case SettingWindowButton)
